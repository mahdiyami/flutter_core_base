...
final Logger  _logger = Logger(
    ...
    printer: PrettyPrinter(
      ...
      // },
        ...
        printTime: true // Should each log message be timestamped
...
extension ConsoleLoggerExtension on Object {
  // sl<ConfigManager>().getConfig<LogConfig>()!.logger;
  // CustomLogOutput get customLogOutput =>
  //     sl<ConfigManager>().getConfig<LogConfig>()!.output as CustomLogOutput;
